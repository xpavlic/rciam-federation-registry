...
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 1','https://cdn.vox-cdn.com/thumbor/0n6dqQfk9MuOBSiM39Pog2Bw39Y=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/19341372/microsoftedgenewlogo.jpg','demo','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','approved',1,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 2','https://i.pinimg.com/originals/33/b8/69/33b869f90619e81763dbf1fccc896d8d.jpg','production','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','approved',2,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 3','https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcROY_lTxPGm6_XjUncdBfqkSbRoFoEf4BLBlQ&usqp=CAU','demo','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','approved',3,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 4','https://brandmark.io/logo-rank/random/pepsi.png','development','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','approved',4,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 5','https://brandmark.io/logo-rank/random/pepsi.png','development','7a6ae5617ea76389401e3c3839127fd2a019572066d40c5d0176bd242651f934@tenant_1.eu','approved',5,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 5 new','https://images.fastcompany.net/image/upload/w_596,c_limit,q_auto:best,f_auto/fc/3034007-inline-i-applelogo.jpg','development','7a6ae5617ea76389401e3c3839127fd2a019572066d40c5d0176bd242651f934@tenant_1.eu','edit',5,'oidc','tenant_1','gr','2021-01-27 10:23:54',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
...
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Saml 6','https://cdn.auth0.com/blog/duo-saml-exploit/saml.png','development','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','approved','create',6,'2020-10-4 13:18:11','saml','tenant_1','gr',1);

INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,group_id,tenant,country,organization_id)
...
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,group_id,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','tenant_2 OIDC Service 2','https://nat.sakimura.org/wp-content/uploads/2012/02/openid-icon-250x250.png','production','4e38406c89591bb08e070accbce62140cfc8beb40314c03aa82cf3683ac270b5@aai.tenant_2-portal.eu','approved',8,'2004-10-19 10:23:54','oidc',9,'tenant_2','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,status,service_id,reviewed_at,protocol,group_id,tenant,country,organization_id)
