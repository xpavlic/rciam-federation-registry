...
service_details_saml,service_details,service_petition_localizations,service_localizations,service_state,user_roles,role_actions,role_entitlements,groups,invitations,group_subs,tenant_deployer_agents,banner_alerts,deployment_tasks,service_errors,organizations,service_tags,tenants;
...
create table service_details (
  ...
  service_name_localized VARCHAR(255),
  group_id INTEGER,
...
create table service_policies (
  ...
  name VARCHAR(256),
  url VARCHAR(2048),
  url_localized VARCHAR(2048),
  FOREIGN KEY (owner_id) REFERENCES service_details(id) ON DELETE CASCADE
);

create table service_infrastructures (
  id SERIAL PRIMARY KEY,
  owner_id bigint,
  value VARCHAR(256),
  FOREIGN KEY (owner_id) REFERENCES service_details(id) ON DELETE CASCADE
...
create table service_petition_infrastructures (
  id SERIAL PRIMARY KEY,
  owner_id bigint,
  value VARCHAR(256),
  FOREIGN KEY (owner_id) REFERENCES service_petition_details(id) ON DELETE CASCADE
...
create table service_petition_policies (
  id SERIAL PRIMARY KEY,
  owner_id bigint,
  name VARCHAR(256),
  url VARCHAR(2048),
...
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 1','https://cdn.vox-cdn.com/thumbor/0n6dqQfk9MuOBSiM39Pog2Bw39Y=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/19341372/microsoftedgenewlogo.jpg','demo','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','oidc',1,'tenant_1',1,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 2','https://i.pinimg.com/originals/33/b8/69/33b869f90619e81763dbf1fccc896d8d.jpg','production','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','oidc',2,'tenant_1',2,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 3','https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcROY_lTxPGm6_XjUncdBfqkSbRoFoEf4BLBlQ&usqp=CAU','demo','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','oidc',3,'tenant_1',3,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 4','https://brandmark.io/logo-rank/random/pepsi.png','development','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','oidc',4,'tenant_1',4,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 5','https://brandmark.io/logo-rank/random/pepsi.png','development','7a6ae5617ea76389401e3c3839127fd2a019572066d40c5d0176bd242651f934@tenant_1.eu','oidc',5,'tenant_1',5,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Saml 6','https://cdn.auth0.com/blog/duo-saml-exploit/saml.png','development','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','saml',6,'tenant_1',6,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','tenant_2 OIDC Service 1','https://nat.sakimura.org/wp-content/uploads/2012/02/openid-icon-250x250.png','development','4e38406c89591bb08e070accbce62140cfc8beb40314c03aa82cf3683ac270b5@aai.tenant_2-portal.eu','oidc',8,'tenant_2',1,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','tenant_2 OIDC Service 2','https://nat.sakimura.org/wp-content/uploads/2012/02/openid-icon-250x250.png','development','4e38406c89591bb08e070accbce62140cfc8beb40314c03aa82cf3683ac270b5@aai.tenant_2-portal.eu','oidc',9,'tenant_2',2,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','tenant_2 SAML Service 1','https://cdn.auth0.com/blog/duo-saml-exploit/saml.png','demo','4e38406c89591bb08e070accbce62140cfc8beb40314c03aa82cf3683ac270b5@aai.tenant_2-portal.eu','saml',10,'tenant_2',3,'gr',1);
INSERT INTO service_details (service_description,service_name,logo_uri,integration_environment,requester,protocol,group_id,tenant,external_id,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','tenant_1 saml Service 2','https://cdn.auth0.com/blog/duo-saml-exploit/saml.png','demo','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','saml',11,'tenant_1',3,'gr',1);
...
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 1','https://cdn.vox-cdn.com/thumbor/0n6dqQfk9MuOBSiM39Pog2Bw39Y=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/19341372/microsoftedgenewlogo.jpg','demo','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','create','approved',1,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 2','https://i.pinimg.com/originals/33/b8/69/33b869f90619e81763dbf1fccc896d8d.jpg','production','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','create','approved',2,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 3','https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcROY_lTxPGm6_XjUncdBfqkSbRoFoEf4BLBlQ&usqp=CAU','demo','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','create','approved',3,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 4','https://brandmark.io/logo-rank/random/pepsi.png','development','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','create','approved',4,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 5','https://brandmark.io/logo-rank/random/pepsi.png','development','7a6ae5617ea76389401e3c3839127fd2a019572066d40c5d0176bd242651f934@tenant_1.eu','create','approved',5,'2004-10-19 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 5 new','https://images.fastcompany.net/image/upload/w_596,c_limit,q_auto:best,f_auto/fc/3034007-inline-i-applelogo.jpg','development','7a6ae5617ea76389401e3c3839127fd2a019572066d40c5d0176bd242651f934@tenant_1.eu','edit','pending',5,'2021-01-27 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 7','https://www.bookmarks.design/media/image/hatchful.jpg','development','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','create','pending',7,'2021-01-29 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Client 1','https://cdn.vox-cdn.com/thumbor/0n6dqQfk9MuOBSiM39Pog2Bw39Y=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/19341372/microsoftedgenewlogo.jpg','demo','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','delete','pending',1,'2021-01-28 10:23:54','oidc','tenant_1','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','Saml 6','https://cdn.auth0.com/blog/duo-saml-exploit/saml.png','development','4359841657275796f20734f26d7b60c515f17cd36bad58d29ed87d000d621974@tenant_1.eu','create','approved',6,'2020-10-4 13:18:11','saml','tenant_1','gr',1);

INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,group_id,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','tenant_2 OIDC Service 1','https://nat.sakimura.org/wp-content/uploads/2012/02/openid-icon-250x250.png','demo','4e38406c89591bb08e070accbce62140cfc8beb40314c03aa82cf3683ac270b5@aai.tenant_2-portal.eu','create','approved',7,'2004-10-19 10:23:54','oidc',8,'tenant_2','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,group_id,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','tenant_2 OIDC Service 2','https://nat.sakimura.org/wp-content/uploads/2012/02/openid-icon-250x250.png','production','4e38406c89591bb08e070accbce62140cfc8beb40314c03aa82cf3683ac270b5@aai.tenant_2-portal.eu','create','approved',8,'2004-10-19 10:23:54','oidc',9,'tenant_2','gr',1);
INSERT INTO service_petition_details (service_description,service_name,logo_uri,integration_environment,requester,type,status,service_id,reviewed_at,protocol,group_id,tenant,country,organization_id)
VALUES ('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean in ex in tellus congue commodo. Suspendisse condimentum purus ante, in ornare leo egestas ut.','tenant_2 SAML Service 1','https://cdn.auth0.com/blog/duo-saml-exploit/saml.png','demo','4e38406c89591bb08e070accbce62140cfc8beb40314c03aa82cf3683ac270b5@aai.tenant_2-portal.eu','create','approved',9,'2004-10-19 10:23:54','saml',10,'tenant_2','gr',1);
