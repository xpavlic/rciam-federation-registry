...
const {ServiceContacts,ServiceDetailsProtocol,ServiceErrors,Invitation,Tenants,DeploymentTasks,ServiceState,Group,ServiceDetails,DeployerAgents,Tokens,User,UserInfo,UserRole,UserEduPersonEntitlement,ServiceMultiValued,ServicePetitionDetails,Service,Petition,ServiceList,Organizations, BannerAlerts, ServiceTags, ServicePolicies} = require('./repos');
...
const initOptions = {
    ...
    extend(obj, dc) {
        ...
        obj.service_policies = new ServicePolicies(obj,pgp);
